...
from .api_endpoints import TaskListCreateAPIView, TaskRetrieveUpdateDestroyAPIView, TaskChangeStatusAPIView, TaskRejectAPIView, TaskApproveAPIView, TaskHistoryAPIView, TaskAssignAPIView, TaskChangePriorityAPIView
...
urlpatterns = [
    ...
    path("<int:pk>/change_priority/", TaskChangePriorityAPIView.as_view(), name="task-change-priority"),
